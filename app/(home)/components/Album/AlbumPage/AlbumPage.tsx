...
import EditAlbumPictures from '@/app/(home)/components/Album/AlbumPage/EditAlbumPictures'
import { useRouter } from 'next/navigation'
import EditAlbumInfo from '@/app/(home)/components/Album/AlbumPage/EditAlbumInfo'
